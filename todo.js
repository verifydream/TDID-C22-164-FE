...
function setTodos(localTodo) {
  fetch(
    `https://tdid-c22-164-be.vercel.app/set-todo`,
    {
      method: "POST",
      headers: {
        accept: "*/*",
...
function getAllTodoList() {
  fetch(
    `https://tdid-c22-164-be.vercel.app/list?filter=All`, { cache: "no-store" }
  )
...
function btnAddClick() {
  ...
  fetch(
    "https://tdid-c22-164-be.vercel.app/list",
    {
      method: "POST",
      headers: {
        accept: "*/*",
...
function btnCompleteClick(id) {
  fetch(
    `https://tdid-c22-164-be.vercel.app/list/${id}`,
    {
      method: "PUT",
      headers: {
        accept: "*/*",
...
function updateTodo() {
  fetch(
    `https://tdid-c22-164-be.vercel.app/list/${editId.value}`,
    {
      method: "POST",
      headers: {
        accept: "*/*",
...
function reminder() {
  fetch(
    `https://tdid-c22-164-be.vercel.app/list?filter=Pending`
  )
    .then((response) => response.json())
    .then((data) => {
      ...
      data.forEach(function (value, index) {
        ...
        if (dates.length > 1) {
          ...
          if (dif <= 300 && today < todoDate && value.status != "Complete") {
            ...
            fetch(
              `https://tdid-c22-164-be.vercel.app/notif/${value.id}`,
              {
                method: "PUT",
                headers: {
                  accept: "*/*",
