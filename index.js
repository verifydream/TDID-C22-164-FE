...
function setTodos(localTodo) {
  fetch(`https://tdid-c22-164-be.vercel.app/set-todo`, {
    method: "POST",
    headers: {
      accept: "*/*",
...
function getTodayList() {
  fetch(`https://tdid-c22-164-be.vercel.app/today`)
    .then((response) => response.json())
    .then((data) => {
      displayTodos(data);
      fetch(`https://tdid-c22-164-be.vercel.app/list?filter=All`, { cache: "no-store" })
        .then((response) => response.json())
        .then((data) => {
...
function getThisWeekRecap() {
  fetch(`https://tdid-c22-164-be.vercel.app/this-week-recap`)
    .then((response) => response.json())
...
function btnDeleteClick(id) {
  fetch(`https://tdid-c22-164-be.vercel.app/list/${id}`, {
    method: "DELETE",
    headers: {
      accept: "*/*",
      "content-type": "application/json",
...
function reminder() {
  fetch(`https://tdid-c22-164-be.vercel.app/list?filter=Pending`)
    .then((response) => response.json())
    .then((data) => {
      ...
      data.forEach(function (value, index) {
        ...
        if (dates.length > 1) {
          ...
          if (dif <= 300 && today < todoDate && value.status != "Complete") {
            ...
            fetch(`https://tdid-c22-164-be.vercel.app/notif/${value.id}`, {
              method: "PUT",
              headers: {
                accept: "*/*",
                "content-type": "application/json",
